      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="hero-sub">
            Register your property privately and connect with matched buyers — or check whether demand already exists at your address before you do anything else. No obligation either way.
          </p>
          <div className="hero-actions">
            <Link href="/register?intent=seller" className="btn btn-primary btn-lg">
        ...
        <div className="container">
          ...
          <div className="steps" style={{ marginTop: 'var(--space-10)' }}>
            {[
              ...
              { n: '02', title: 'Register as privately available', body: 'If you\'re open to a private sale, create a free account and register your property. It never appears publicly — only matched buyers are notified.' },
        ...
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 'var(--space-8)', flexWrap: 'wrap' }}>
          <div>
            ...
            <p style={{ color: 'var(--slate)', fontSize: 'var(--text-base)' }}>
              List your property privately, or check demand at your address first — both are free.
            </p>
          </div>
          <div style={{ display: 'flex', gap: 'var(--space-3)', flexWrap: 'wrap' }}>
            <Link href="/register?intent=seller" className="btn btn-primary btn-lg">List my property — free</Link>
            <Link href="/sellers/check" className="btn btn-outline-dark btn-lg">Check demand first</Link>
          </div>
        </div>
      </section>
    </>
