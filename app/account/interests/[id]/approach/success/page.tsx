      ...
      <div style={{ maxWidth: 560 }}>
        ...
        <div className="card" style={{ marginBottom: 'var(--space-4)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
            {[
              { title: 'We research the owner', body: 'We look up the registered owner via HM Land Registry. If there\'s an issue, we\'ll contact you directly.' },
              { title: 'The letter is sent', body: 'A professionally written, personally addressed letter goes out within 3–5 working days with a secure private response link.' },
              { title: 'We notify you if they respond', body: 'If the owner responds, you\'ll get an email notification and can view their response in your account.' },
              { title: 'Your interest stays active', body: 'Regardless of the outcome, your interest remains registered. You\'ll be matched automatically if they later register as available.' },
            ].map((item, i) => (
        ...
        <div style={{ display: 'flex', gap: 'var(--space-3)', flexWrap: 'wrap' }}>
          <Link href="/account" className="btn btn-primary">Back to my interests</Link>
          <Link href="/account/add-interest" className="btn btn-outline-dark">Register another interest</Link>
        </div>
