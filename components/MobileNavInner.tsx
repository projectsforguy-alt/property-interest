...
export default function MobileNavInner({ isLoggedIn = false }: { isLoggedIn?: boolean }) {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div
        id="mob-backdrop"
        style={{ display: 'none', position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 200 }}
      />
